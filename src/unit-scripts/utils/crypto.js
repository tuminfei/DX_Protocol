...
const { byteArrayToWordArray, wordArrayToByteArray, generateChecksum } = require('./binary.js')
...
function getAccountCredentials(mnemonic, subAccount) {
  ...
  return Secp256k1KeyIdentity.fromKeyPair(keyPair.publicKey, keyPair.privateKey)
}
